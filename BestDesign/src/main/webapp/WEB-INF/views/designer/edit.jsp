<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String userID = (String)session.getAttribute("userID");
       if(!designer.equals(userID)){
        	...
        	session.setAttribute("messageContent", "본인만 수정 가능합니다.");
        	response.sendRedirect("../designer/profile.do?designerId="+designer);
        	return;
        }
...
<div class="con">
	<div class="container">
		<form method="post" action="../designer/updateProfile.do" id="updateform">
    		<table class="table table-bordered table-hover" style="text-align : ceneter; border: 1px solid #dddddd">
    			<thead>
    				<tr>
    					<th colspan="3"><h4>프로필 수정</h4></th>
    				</tr>
    			</thead>
    			<tbody>
    				<tr>
    					<td class="tdali"><h5>닉네임</h5></td>
    					<td colspan=2><input class="form-control" type="text" value="${Profile.designerNickName}"id="designerNickName" name="designerNickName" placeholder="닉네임을 입력하세요."></td>
    				</tr>
    				<tr>
    					<td class="tdali"><h5>내 정보</h5></td>
    					<td colspan=2><textarea class="form-control" style="height: 300px;" id="designerProfile" name="designerProfile" placeholder="정보를 입력하세요.">${Profile.designerProfile}</textarea></td>
    				</tr>
    				<tr>
