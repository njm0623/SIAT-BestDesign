...
<body>
	...
	<div class="container">
		<form method="post" action="../user/memberupdate.do">
			<table class="table table-bordered table-hover"
				style="text-align: ceneter; border: 1px solid #dddddd">
				<thead>
					<tr>
				...
				<%-- 	<tr>
						...
						<td colspan="2"><input class="form-control" type="password"
							...
							placeholder="비밀번호를 입력하세요.">"${userPwd}"</td>
					</tr>
					<tr>
						<td style="width: 150px;"><h5>비밀번호 확인</h5></td>
						<td colspan="2"><input class="form-control" type="password"
							id="userPwdconf" name="userPwdconf" maxlength="20"
							placeholder="비밀번호를 확인하세요">"${userPwd}"</td>
					</tr> --%>
					<tr>
						<td style="width: 150px;"><h5>이름</h5></td>
						<td colspan="2"><input class="form-control" type="text"
							id="userName" name="userName" maxlength="20"
							placeholder="이름을 입력하세요." value="${user.userName}"></td>
					</tr>
					<tr>
						<td style="width: 150px;"><h5>전화번호</h5></td>
						<td colspan="2"><input class="form-control" type="text"
							id="userPhone" name="userPhone" maxlength="13"
							placeholder="전화번호를 입력하세요." value="${user.userPhone}"></td>
					</tr>
					<tr>
						<td style="width: 150px;"><h5>이메일</h5></td>
						<td colspan="2"><input class="form-control" type="email"
							id="userEmail" name="userEmail" maxlength="50"
							placeholder="이메일을 입력하세요." value="${user.userEmail}"></td>
					</tr>
					<tr>
						<td style="width: 150px;"><h5>생년월일</h5></td>
						<td colspan="2"><input class="form-control" type="date"
							id="userBirth" name="userBirth" maxlength="20"
							placeholder="6자리를 입력해주세요." value="${user.userBirth}"></td>
					</tr>
					<tr>
						<td style="width: 150px;"><h5>유형</h5></td>
						<td colspan="2">
							<div class="form-group"
								style="text-align: center; margin: 0 auto;">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn  btn-primary active"> <input
										type="radio" name="userType" autocomplete="off" value="1"
										checked>고객
									</label> <label class="btn  btn-primary"> <input type="radio"
										name="userType" autocomplete="off" value="2">디자이너
									</label>
								</div>
							</div>
						</td>
	...
	<div class="modal fade" id="messageModal" tabindex="-1" role="dialog"
		...
		<div class="vertical-alignment-helper">
			<div class="modal-dialog vertical-align-center">
				<div
					class="modal-content <%if (messageType.equals("오류"))
