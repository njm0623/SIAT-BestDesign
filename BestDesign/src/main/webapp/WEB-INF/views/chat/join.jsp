    		...
    		<table class="table table-bordered table-hover" style="text-align : ceneter; border: 1px solid #dddddd">
    			...
    			<tbody>
    				<tr>
    					...
    					<td><input class="form-control" type="text" id="userID" name="userID"  placeholder="아이디를 입력하세요."><span id="red"></span></td>
    					<td style="width: 110px;"><button class="btn btn-primary" type="button" id="checkId">중복체크</button></td>
    				</tr>
    				<tr>
    				...
    				<tr>
    					...
    					<td colspan="2"><input class="form-control" type="text" id="userPhone" name="userPhone" maxlength="20" placeholder="- 제외하고 입력해주세요."></td>
    				</tr>
    				<tr>
    				...
    				<tr>
    					...
    					<td colspan="2"><input class="form-control" type="date" id="userBirth" name="userBirth" maxlength="20" placeholder="6자리를 입력해주세요."></td>
    				</tr>
    				<tr>
