...
<jsp:include page="../main/header.jsp"/>
	...
	<h4> 게시판 글 보기 </h4><br/>
	<table border="1" bordercolor="red" id="table1">
	<tr>
		<td colspan="2" id="td2">${rec.contactTitle}</td>
	</tr>
	<tr>
		<td colspan="2" id="td1"> <span id="whghl1">  ${rec.userId} </span>  <br>  ${rec.contactDate}  <span id="whghl"> 조회수 : ${rec.contactCount} </span></td>
		
	</tr>
	<tr height="300">
		
		 <td colspan="2" tyle="border-top: none;"id="td3">내  용 : ${rec.contactContent}</td>
	</tr>
	<tr>
		<td colspan="2">
	...
	<!-- 			
	 ...
	 -->	
			<button id=".btn-primary.focus"><a href="boardList.do"> 목록보기 </a></button>
			<button id=".btn-primary.focus"><a href="BoardReplyForm.do?parentId=${rec.contactNum}"> 답변하기 </a></button>
