...
<head>
	...
	<script>
		...
		function getFriend(findID){
			$("#friendResult").html("<thead><tr><th><h4>검색결과</h4></th></tr></thead><tbody><tr><td style='text-align: center;'><h3>"+findID+"</h3><a href='chat.jsp?toID="+findID+"' class='btn btn-primary pull-right'>메시지 보내기</a></td></tr></tbody>")
		}
   ...
   <div class="container">
   		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
   			...
   			<tbody>
   				...
   				<tr>
   					<td colspan="2"><button class="btn btn-primary pull-right" id="find-btn">검색</button></td>
   				</tr>
   			</tbody>
   		</table>
   </div>
