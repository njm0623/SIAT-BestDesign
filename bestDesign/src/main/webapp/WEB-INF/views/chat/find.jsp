...
<style>
	...
	<script>
		...
		function getFriend(findID, type){
			$("#friendResult").html("<thead><tr><th><h4>검색결과</h4></th></tr></thead><tbody><tr><td style='text-align: center;'><h3>"+type+" : "+findID+"</h3><a href='chat.do?toID="+findID+"&type="+type+"' class='btn btn-primary pull-right'>메시지 보내기</a></td></tr></tbody>")
		}
		function failFriend(){
			$("#friendResult").html("");
		}
   						...
   						<div class="form-group" style="text-align: center; margin: 0 auto;">
    							<div class="btn-group" data-toggle="buttons">
    								<label class="btn  btn-primary active">
    									<input type="radio" name="userType" autocomplete="off" value="고객" >고객
    								</label>
